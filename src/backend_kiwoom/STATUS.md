...
| 7 | C-2α 상속 (foreign_holding_ratio / credit_ratio NUMERIC magnitude / idx_daily_flow_exchange cardinality) | ADR § 18.4 | **daily_flow 백필 CLI 완료 (ADR § 27)** — 사용자 수동 실측 후 § 27.5 채움 |
